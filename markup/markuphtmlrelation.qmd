...
[Lab statement on Lab#01-1: Create and publish by Quarto](/markup/mulab1.qmd)

### Approach #3: HTML + CSS + JS

From ``w3.css``: [W3.CSS Navigation Tabs](https://www.w3schools.com/w3css/w3css_tabulators.asp)

[Lab statement on Lab#02-2: Maven/Gradle Person and Account stored in JSON](/javase/selab1-2.qmd)
...
### Approach #4: if it is able to import MDReadme
