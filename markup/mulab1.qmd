...
1. Installations:
    1. **Visual Code**
      1. Install GitHub Extension and Source Control (maybe the come with Visual Code)
      2. Sign in GitHub in Visual Code (wizard)
      3. Install **Quarto Extension** in Visual Code
    2. **Quarto** in your OS (download from Quarto site)
2. [Create Quarto Project](/markup/markupquartocreating.qmd)
3. GitHub jobs:
