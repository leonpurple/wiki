...
::: {.summary}
**Polymorphism** is a fundamental concept in object-oriented programming. It is the ability of an object to take on different forms. In other words, it is the ability of a single object **to behave differently in different contexts**.
:::
---
